...
CROR_INDEX_OPTION_WRITER_NEAR_ITM_LOTS = env_int("CROR_INDEX_OPTION_WRITER_NEAR_ITM_LOTS", "2000")
CROR_INDEX_OPTION_WRITER_MID_ITM_LOTS = env_int("CROR_INDEX_OPTION_WRITER_MID_ITM_LOTS", "750")
